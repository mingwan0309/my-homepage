...
function init(){
  ...
  function injectStyles(){
    var css =
      ...
      +'#mk-notice-modal h2{font-size:18px;font-weight:900;color:#1e293b;margin-bottom:14px;padding-right:54px;}'
      +'#mk-notice-close{position:absolute;top:8px;right:8px;width:44px;height:44px;display:flex;align-items:center;justify-content:center;font-size:22px;cursor:pointer;color:#94a3b8;background:none;border:none;}'
